          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary mb-2">
                <AnimatedNumber end={15000} suffix="+" duration={2000} startOnView={false} />
              </div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary mb-2">
                <AnimatedNumber end={800} suffix="+" duration={2000} startOnView={false} />
              </div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary mb-2">
                <AnimatedNumber end={75000} suffix="+" duration={2000} startOnView={false} />
              </div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-primary mb-2">
                <AnimatedNumber end={92} suffix="%" duration={2000} startOnView={false} />
              </div>
